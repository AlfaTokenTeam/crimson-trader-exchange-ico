...
import "./CrimsonTraderExchange.sol";

contract CrimsonTraderExchangePreSale {
    CrimsonTraderExchange public token;
    ...
    function CrimsonTraderExchangePreSale(
        CrimsonTraderExchange _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = CrimsonTraderExchange(_token);
